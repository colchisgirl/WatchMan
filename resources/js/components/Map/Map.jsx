...
const MAPBOX_TOKEN =
    "pk.eyJ1IjoieWFuZWtrcmlzIiwiYSI6ImNrYnoxODl2aTBqbzEycm1yaW03NzdkM3AifQ.37oJsDI3o7haiPOyTBeg8w";
            ...
            <div className="map__container" >
                ...
                >
                    ...
                    <Marker
                        ...
                        onDragEnd={e => {
                            this.setState({
                                markerLat: e.lngLat[1],
                                markerLong: e.lngLat[0],
                            });
                        ...
                        >
                            <div className="landmark__popup">
                                <div className="landmark__popup__top">
                                    <img
                                        className="landmark__popup__img"
                                        src={`/img/${selectedLandmark.images[0].url}`}
                                        alt=""
                                    />
                                    <div className="landmark__popup__title">
                                        <h2>{selectedLandmark.title}</h2>
                                        <p>
                                            {selectedLandmark.house_number}{" "}
                                            {selectedLandmark.street},{" "}
                                ...
                                <div className="landmark__popup__bottom">
                                    <Link
                                        to={`/landmarks/${selectedLandmark.id}/createEvent`}
                                        params={{ testvalue: "hello" }}
                                    >
                                        Add Event
                                    </Link>
                                    <Link
                                        to={`/landmarks/${selectedLandmark.id}`}
                                        params={{ testvalue: "hello" }}
                                    >
                                        See more details...
                                    </Link>
